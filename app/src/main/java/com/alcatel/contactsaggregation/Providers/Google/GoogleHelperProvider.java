...
class GoogleHelperProvider {
     ...
     */
    protected static String getAuthURI(String loginHint) {
    ...
    protected static String getAllContactURI(String loginHint) {
        String alt = "json";
     ...
     * @param loginHint A google user account (gmail address)
     */
    protected static void updateAccessToken(String loginHint) {

        String authUri = GoogleHelperProvider.getAuthURI(loginHint);                // prepare the auth endpoint uri
